          ...
          <div className="block lg:hidden space-y-6">
            ...
            <div>
              <div className="text-center mb-4">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Registration & Information</h2>
                <p className="text-gray-600 dark:text-gray-400">For registration queries and general information</p>
              </div>
            ...
            {/* Local Support & Information Section */}
            <div>
              <div className="text-center mb-4">
                <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-2">Local Support & Information</h2>
                <p className="text-gray-600 dark:text-gray-400">For local assistance and support</p>
              </div>
              <div className="space-y-4">
                {/* Contact Card 3 */}
                <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                  ...
                  <div className="p-6">
                    <div className="text-center mb-4">
                      <div className="font-semibold text-lg text-gray-900 dark:text-gray-100 mb-2">Dharmedrasinh Parmar</div>
                    </div>
                    <div className="text-center">
                      <Button
          ...
          <div className="hidden lg:block mx-auto max-w-4xl">
            ...
            <div className="mb-8">
              <div className="text-center mb-6">
                <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-3">Registration & Information</h2>
                <p className="text-lg text-gray-600 dark:text-gray-400">For registration queries and general information</p>
              </div>
            ...
            <div>
              <div className="text-center mb-6">
                <h2 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-3">Local Support & Information</h2>
                <p className="text-lg text-gray-600 dark:text-gray-400">For local assistance and support</p>
              </div>
              <div className="overflow-x-auto">
                <table className="w-full border-collapse bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
                  <thead>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td className="bg-blue-50 dark:bg-blue-900/20 px-6 py-4 text-center border-b border-gray-200 dark:border-gray-700">
                        <div className="font-semibold text-lg">Dharmedrasinh Parmar</div>
                      </td>
                      <td className="bg-blue-50 dark:bg-blue-900/20 px-6 py-4 text-center border-b border-gray-200 dark:border-gray-700">
                        <Button
                          onClick={() => window.open('tel:+919998933283')}
